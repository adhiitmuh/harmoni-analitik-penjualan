  ...
  <div class="card card-full">
    <div class="card-title" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:center">
        ...
        <button onclick="document.getElementById('invTokoInput').click()" style="padding:6px 14px;background:#0369a1;color:#fff;border:none;border-radius:8px;font-size:.8rem;font-weight:600;cursor:pointer;font-family:'Raleway',sans-serif">🏪 Upload Stok Toko</button>
        <span id="invTokoLabel" style="font-size:.75rem;color:#0369a1;font-weight:600"></span>
        <button onclick="document.getElementById('invGudangInput').click()" style="padding:6px 14px;background:#7c3aed;color:#fff;border:none;border-radius:8px;font-size:.8rem;font-weight:600;cursor:pointer;font-family:'Raleway',sans-serif">🏭 Upload Stok Gudang</button>
  ...
  <div class="card card-full">
    ...
    <div class="table-wrap"><table style="border-collapse:separate;border-spacing:0">
      <thead><tr>
        ...
        <th class="tr" style="background:#f0fdf4;color:#166534">Total Stok</th>
...
function renderStok(data){{
  ...
  data.forEach((s,i)=>{{
    ...
    tb.innerHTML+=`<tr>
      ...
      <td class="tr num" style="font-weight:700;color:${{stOk?'#166534':'#dc2626'}}">${{stTotal>0?stTotal:'—'}}</td>
