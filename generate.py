  ...
  <div class="card card-full">
    <div class="card-title" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:center;margin-top:6px">
        ...
        <span id="stokGudangLabel" style="font-size:.75rem;color:#7c3aed;font-weight:600"></span>
...
(function(){{
  ...
  if(nt>0) setTimeout(()=>{{ const el=document.getElementById('stokTokoLabel'); if(el) el.textContent='✓ Toko: '+nt+' SKU'; }},100);
  if(ng>0) setTimeout(()=>{{ const el=document.getElementById('stokGudangLabel'); if(el) el.textContent='✓ Gudang: '+ng+' SKU'; }},100);
}})();
